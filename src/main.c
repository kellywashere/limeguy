...
struct limeguy_color rgba_palette[] = {
	{.r=0x9B, .g=0xBC, .b=0x0F, .a=0xFF},  // 00: #7C7A48
	{.r=0x8B, .g=0xAC, .b=0x0F, .a=0xFF},  // 01: #666E4A
	{.r=0x30, .g=0x62, .b=0x30, .a=0xFF},  // 10: #57664F
	{.r=0x0F, .g=0x38, .b=0x0F, .a=0xFF},  // 11: #585C47
	{.r=0xCA, .g=0xDC, .b=0x9F, .a=0xFF}   // off:#947520
};
*/
struct limeguy_color rgba_palette[] = {
